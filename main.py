...
# Recall that `positions` is first defined in the outmost scope
# and later being modified as global inside the function `draw_circle()`.

# Why RANSAC?
if len(positions) != 4:
    print("You did not choose the rectangle on `building.jpeg`")
    print("As a result: Nothing is done.")
else:
    ...
    print("Saving the result to `final.png`")
